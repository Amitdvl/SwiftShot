...
final class ScrollingCaptureSession {
    ...
    private var onExtentChange: ((ScrollingCaptureExtent) -> Void)?
    ...
    func start(for region: CaptureRegionReference,
               onExtentChange: ((ScrollingCaptureExtent) -> Void)? = nil,
        ...
        self.onExtentChange = onExtentChange
            ...
            consumeTask = Task { [weak self] in
                ...
                do {
                    for try await frame in frames {
                        ...
                        if let extent = result.extent { self.onExtentChange?(extent) }
